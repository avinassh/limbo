...
use crate::{
    ast, function,
    io::{MemoryIO, IO},
    is_main_or_temp_db, parse_schema_rows, refresh_analyze_stats, translate,
    util::IOExt,
...
impl Connection {
    ...
    pub(crate) fn with_database_schema_mut<T>(
        ...
        if is_main_or_temp_db(database_id) {
